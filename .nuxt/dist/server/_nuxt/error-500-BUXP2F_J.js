...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${serverRenderer_cjs_prodExports.ssrRenderAttrs(vueExports.mergeProps({ class: "antialiased bg-white dark:bg-black dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-black" }, _attrs))} data-v-d80f455e><div class="-bottom-1/2 fixed h-1/2 left-0 right-0 spotlight" data-v-d80f455e></div><div class="max-w-520px text-center" data-v-d80f455e><h1 class="font-medium mb-8 sm:text-10xl text-8xl" data-v-d80f455e>${serverRenderer_cjs_prodExports.ssrInterpolate(__props.statusCode)}</h1><p class="font-light leading-tight mb-16 px-8 sm:px-0 sm:text-4xl text-xl" data-v-d80f455e>${serverRenderer_cjs_prodExports.ssrInterpolate(__props.description)}</p></div></div>`);
    };
  }
};
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.15.4_@parcel+watcher@2.5.1_@types+node@22.12.0_db0@0.2.3_eslint@8.57.1_ioredis@5_55fd7895796c14f8b86b6ecc17c40b52/node_modules/nuxt/dist/app/components/error-500.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const error500 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d80f455e"]]);
export {
  error500 as default
};
//# sourceMappingURL=error-500-BUXP2F_J.js.map
